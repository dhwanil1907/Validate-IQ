...
const badgeClass =
  "rounded-full border border-[rgba(255,255,255,0.1)] bg-[rgba(255,255,255,0.05)] px-4 py-2 text-sm text-[#d4d4d8] transition-[border-color,background-color] duration-200 ease-out hover:border-[#6366f1] hover:bg-[rgba(99,102,241,0.08)]"
...
function LockSeal({ active }: { active: boolean }) {
  return (
    <div className="mb-8 flex justify-center" aria-hidden>
      <div className="flex h-12 w-12 items-center justify-center rounded-full border border-[rgba(255,255,255,0.08)] bg-[rgba(255,255,255,0.03)]">
        <svg width="28" height="28" viewBox="0 0 24 24" fill="none" className="overflow-visible text-[#6366f1]">
...
export function TrustSection() {
  ...
  return (
    <section
      ref={ref}
      className="bg-[#0a0a0f] px-4 py-20 [font-family:var(--font-inter),system-ui,sans-serif]"
    >
      <div className="mx-auto max-w-2xl text-center">
        ...
        <p className="mt-4 text-pretty text-base leading-relaxed text-[#a1a1aa] sm:text-[1.05rem]">
